...
export async function startShell() {
    ...
    // Check if we are really on Termux/Linux that supports proot-distro
    ...
    if (hasProot) {
        ...
        p.log.info(chalk.yellow('Win32 Environment Detected. Starting XTermLite Pseudo-Shell...'));
        ...
        while (true) {
            ...
            } else if (input === 'uname -a') {
                console.log('Linux localhost 5.10.117-android #1 SMP PREEMPT Fri Jan 24 12:00:00 UTC 2026 aarch64 GNU/Linux');
